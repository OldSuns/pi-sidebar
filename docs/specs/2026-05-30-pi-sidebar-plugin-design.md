...
- **Plugin API shape:** expose `/sidebar`, `/sidebar-refresh`, `/sidebar-git-detail`, and `/sidebar-panels`.
...
- **Configuration:** environment variables avoid inventing a settings file format: `PI_SIDEBAR_ENABLED`, `PI_SIDEBAR_WIDTH`, `PI_SIDEBAR_FULL_HEIGHT`, `PI_SIDEBAR_BUFFER`, `PI_SIDEBAR_FILL_ROWS`, `PI_SIDEBAR_MIN_TERM_WIDTH`, `PI_SIDEBAR_OFFSET_Y`, `PI_SIDEBAR_AUTOHIDE_WORKING`, `PI_SIDEBAR_REFRESH_MS`, `PI_SIDEBAR_GIT_LINES`, `PI_SIDEBAR_MAX_FILES`, `PI_SIDEBAR_GIT_DETAIL`.
